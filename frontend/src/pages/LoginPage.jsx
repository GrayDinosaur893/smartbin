...
import { Trash2, Eye, Mail, Lock } from 'lucide-react';
    ...
    <div className="min-h-screen flex bg-white font-sans">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-24 relative">
        <div className="w-full max-w-md space-y-8">
          ...
          <form className="space-y-5">
            <div className="relative">
              ...
              <input 
                ...
                defaultValue="aishwarya@example.com"
              />
            </div>
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-slate-300 text-[#105a39] focus:ring-[#105a39]" defaultChecked />
                <span className="text-slate-600 font-medium">Remember me</span>
              </label>
              <a href="#" className="text-slate-500 hover:text-[#105a39] font-medium">Forgot Password?</a>
            </div>

            <Link to="/dashboard" className="w-full block text-center bg-[#105a39] hover:bg-[#0b452a] text-white py-3 rounded-lg font-medium transition-colors shadow-lg shadow-emerald-900/20">
              Login
            </Link>
          </form>
          ...
          <button type="button" className="w-full flex items-center justify-center gap-2 bg-white border border-slate-300 hover:bg-slate-50 text-slate-700 py-3 rounded-lg font-medium transition-colors">
